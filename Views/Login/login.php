...
<html lang="es">
  <head>
    ...
    <meta name="author" content="Grupo 2 Construccion Software">
    ...
    <section class="login-content">
      ...
      <div class="login-box">
        ...
        <form class="login-form" name="formLogin" id="formLogin" action="">
          ...
          <div class="form-group">
            <div class="utility">
              <p class="semibold-text mb-2"><a class="color_enlaces" href="#" data-toggle="flip">¿Olvidaste tu contraseña?</a></p>
            </div>
          </div>
          <div id="alertLogin" class="text-center"></div>
          <div class="form-group btn-container">
            <button type="submit" class="btn btn-primary-login btn-block"><i class="fas fa-sign-in-alt"></i> INICIAR SESIÓN</button>
          </div>
        </form>
        <form id="formRecetPass" name="formRecetPass" class="forget-form" action="">
          ...
          <div class="form-group btn-container">
            <button type="submit" class="btn btn-primary-login btn-block"><i class="fa fa-unlock fa-lg fa-fw"></i>REINICIAR</button>
          </div>
